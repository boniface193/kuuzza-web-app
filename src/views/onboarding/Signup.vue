    ...
    <v-row class="onboarding-conatiner">
      <v-col class="pl-7 pr-7 pt-15 pl-sm-15 pr-sm-0 pb-5 col-12 col-md-6">
        ...
        <router-link to="/" class="d-flex dark--text app-logo">
          N<v-img src="@/assets/fire.svg" max-width="35"></v-img>VA
        </router-link>
        ...
        <h1 class="primary--text mt-5 mb-0" v-if="present_form == 'form3'">
        ...
        >
          ...
          <div class="pa-0 mt-5" style="width: 100%">
            <v-btn class="primary px-8 py-5 mb-3" @click="validate_form1"
              >Next</v-btn
            >
            <p>
        ...
        >
          ...
          <!-- button conatainer -->
          <div class="pa-0 mt-5" style="width: 100%">
            <v-btn class="primary px-8 py-5 mb-3" @click="validate_form2"
              >Next</v-btn
            >
          </div>
        </v-form>
        ...
        >
          ...
          <!-- button container -->
          <div class="pa-0 mt-5" style="width: 100%">
            <v-btn class="primary px-8 py-5 mb-3" @click="validate_form3"
...
export default {
  ...
  data: () => ({
    ...
    confirm_passwordRules: [(v) => !!v || "Password is required"],
  }),
  computed: {
    passwordConfirmationRule() {
      //checks if passwords match
      return () =>
        this.create_password === this.confirm_password || "Password must match";
    },
  },
  methods: {
    validate_form1() {
      //validates the first form
