...
notificationHttpClient.interceptors.request.use(notificationRequest);

/** Adding the response interceptors */
notificationHttpClient.interceptors.response.use(
    (response) => {
...
export default notificationHttpClient;