    ...
    <div class="mx-lg-12 mx-md-5 mx-sm-5">
      <div>
        ...
        <router-link to="/seller" style="text-decoration: none; color: #2b2b2b">
          <h4><v-icon class="mb-1 mr-3">mdi-chevron-left</v-icon> Sellers</h4>
        </router-link>
      </div>
      <div class="my-8">
        ...
        <v-row>
          <v-col md="4" v-for="sellers in sellerModels" :key="sellers.name">
            <div class="d-flex">
              ...
              <div class="">
                <p class="subtitles mb-0">Total Items Sold</p>
                <h4 class="headings">10000</h4>
              </div>
            </div>
          </v-col>
        </v-row>
      ...
      <v-row>
        <v-col md="8">
          <v-card class="px-3" width="600px" elevation="0">
            <v-row>
              <v-col class="d-flex">
                <v-img
          ...
          <v-card class="px-3 my-4" width="600px" elevation="0">
            <v-row>
              <v-col class="d-flex">
                <v-img
                  src="../../assets/img/laptop.png"
